...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.125-kourovka-notebook-problem-21.125-58485be2-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.125"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.125-kourovka-notebook-problem-21.125-58485be2-v1",
      "problem_contract_sha256": "73d5425b8fd0a19dd3e3895a88b20af462d484dfce10f35b986c7c9df4b88421",
      "problem_id": "problem:um-kou-21.125-kourovka-notebook-problem-21.125-58485be2",
      "route_id": "route:um-kou-21.125-kourovka-notebook-problem-21.125-58485be2-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.125-kourovka-notebook-problem-21.125-58485be2-source-fidelity-01",
      "graph_id": "graph:um-kou-21.125-kourovka-notebook-problem-21.125-58485be2-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.125-kourovka-notebook-problem-21.125-58485be2-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.125-kourovka-notebook-problem-21.125-58485be2-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $F_m$ be a free group of rank $m$ and let $\\varphi\\in\\operatorname{Aut}(F_m)$ be a polynomially growing automorphism of maximal degree $m-1$, which means that for some (equivalently, any) free basis $\\{x_1,\\ldots,x_m\\}$ of $F_m$, the sequence $\\max_i |\\varphi^n(x_i)|$ grows at the rate of $n^{m-1}$, where $|g|$ denotes the minimal length of $g$ in the $x_i$ and their inverses. a) Is the free-by-cyclic group $F_m\\rtimes_\\varphi\\mathbb Z$ virtually special? b) In particular, are the Hydra groups $G_m=F_m\\rtimes\\mathbb Z=\\langle a_1,\\ldots,a_m,t\\mid t^{-1}a_1t=a_1,\\ t^{-1}a_it=a_ia_{i-1}\\text{ for all }i>1\\rangle$ virtually special?"
          },
          "statement_sha256": "fcf9b82ec0332e46fbf2ac52a738147e7bdc91af43611bcb16db455192e789c1"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.125-kourovka-notebook-problem-21.125-58485be2-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.125-kourovka-notebook-problem-21.125-58485be2-root",
      "route_id": "route:um-kou-21.125-kourovka-notebook-problem-21.125-58485be2-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.125-887bb552fcf4",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.125"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
